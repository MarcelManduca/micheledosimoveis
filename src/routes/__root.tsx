...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Michele Prietsch — Imóveis de alto padrão na Beira Mar Norte" },
      { property: "og:description", content: "Corretora especialista em imóveis de alto padrão em Florianópolis, com foco na Av. Beira Mar Norte." },
