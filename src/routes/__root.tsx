...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://micheledosimoveis.com.br/michele-dos-imoveis-og.jpg?v=3" },
      { property: "og:image:secure_url", content: "https://micheledosimoveis.com.br/michele-dos-imoveis-og.jpg?v=3" },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Michele dos Imóveis — imóveis de alto padrão em Florianópolis" },
      { name: "twitter:image", content: "https://micheledosimoveis.com.br/michele-dos-imoveis-og.jpg?v=3" },
    ],
    links: [
